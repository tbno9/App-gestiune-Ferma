"""
Django settings for gestiune_ferma project.
...
SECRET_KEY = 'django-insecure-pbz_r9d6)q7b87^akbcok94-!3*p0+o1^km_m6fq*+qnh1682('
...
ROOT_URLCONF = 'gestiune_ferma.urls'
...
WSGI_APPLICATION = 'gestiune_ferma.wsgi.application'
